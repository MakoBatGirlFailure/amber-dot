extends Node 
#This script is merebly brought by this video: https://youtu.be/Wnkc_qUXYWs
#All credits for this dude :P

signal progress_changed(progress)
signal load_done 

var _load_screen_path : String = "res://Assets/Scenes/UI/LoadinScreen.tscn"
var _load_screen = load(_load_screen_path)
var _loaded_resource: PackedScene 
var _scene_path: String 
var _progress: Array = []

var use_sub_threads : bool = false  #might freeze the game, if it does, set to false 
...
func _process(_delta):
	...
	match load_status:
		0, 2: #THREAD_LOAD_RESOURCE, THREAD_LOAD_FAILED
			set_process(false)
			return 
